...
export BAT_CONFIG_PATH="${DOTFILES_DIR}/bat.conf"
...
# {{{ Alias
alias sz="exec zsh && echo \"Sourced.\""
...
function at() {
 alacritty-theme-switch --config ~/.config/alacritty/alacritty.yml -s `ls ~/workspace/dotfiles/alacritty/themes/ | fzf`
}
# }}}
